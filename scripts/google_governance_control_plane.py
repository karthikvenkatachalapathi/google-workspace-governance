...
/* 2026-07 user-supplied-governance-brand-v29: transparent light logo and unified icon. */
    ...
    def do_GET(self) -> None:
        try:
            ...
            if path == "/assets/icon-dark.png" and CONTROL_ICON_DARK_PATH.exists():
                ...
                return
            if path == "/favicon.ico" and CONTROL_FAVICON_PATH.exists():
