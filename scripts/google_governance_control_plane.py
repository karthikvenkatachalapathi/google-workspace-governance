...
function showCredentialPane(){if($('settingsTokensTitle'))$('settingsTokensTitle').textContent='MCP Authorization'; credentialActive='gateway'; if($('credentialPane-gateway'))$('credentialPane-gateway').classList.remove('hidden'); if($('credentialTab-gateway')){$('credentialTab-gateway').classList.add('active'); $('credentialTab-gateway').classList.remove('hidden');}}
