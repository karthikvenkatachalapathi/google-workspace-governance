...
""",
    ...
    required_ui = [
        ...
        'collapsed-rail-top-left-menu-v33',
        ...
        'class="muted sectionDescription">Generate the gateway client token MCP clients use to authenticate to this gateway.</p>',
        'id="credentialPane-gateway" class="credentialPane"',
        'id="workspaceTab-agent" class="subItem">2. Configure Agent Identity</button>',
        '<small>Create the workload identity used for ACLs and audit.</small>',
        '<small>Link Google accounts to this gateway.</small>',
        '<small>Map each agent identity to the Google account route it may use.</small>',
        '<small>Send approval requests to configured Telegram approvers.</small>',
        'runtimeTab-postgres',
